 ...
 */
final class Version20210826185050 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE congres DROP salle_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE congres ADD salle_id INT NOT NULL');
    }
}
